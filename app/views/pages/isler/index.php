        ...
        <table class="w-full table-auto">
            <thead>
                <tr class="bg-gray-300">
                    ...
                    <th class="py-4 px-4 font-medium w-40">tarih</th>
                    <th class="py-4 px-4 font-medium text-center">arac_id</th>
                    <th class="py-4 px-4 font-medium text-center">yukleme_yeri</th>
                    <th class="py-4 px-4 font-medium text-center">bosaltma_yeri</th>
                    <th class="py-4 px-4 font-medium text-center">fiyat</th>
                    <th class="py-4 px-4 font-medium">fatura_no</th>
                    <th class="py-4 px-4 font-medium">fatura_tarihi</th>
                    <th class="py-4 px-4 font-medium">odeme_tarihi</th>
                    <th class="py-4 px-4 font-medium">İşlemler</th>
                </tr>
            </thead>
            <tbody>
                <?php foreach ($isler['data'] as $is): ?>
                    <tr>
                        <td class="border-b border-[#eee] py-5 px-4"><?= $is->id ?></td>
                        <td class="border-b border-[#eee] py-5 px-4"><?= $is->tarih ?></td>
                        <td class="border-b border-[#eee] py-5 px-4 text-center"><?= $is->arac_id ?></td>
                        <td class="border-b border-[#eee] py-5 px-4 text-center"><?= $is->yukleme_yeri ?></td>
                        <td class="border-b border-[#eee] py-5 px-4 text-center"><?= $is->bosaltma_yeri ?></td>
                        <td class="border-b border-[#eee] py-5 px-4 text-center"><?= $is->fiyat ?></td>
                        <td class="border-b border-[#eee] py-5 px-4 text-center"><?= $is->fatura_no ?></td>
                        <td class="border-b border-[#eee] py-5 px-4 text-center"><?= $is->fatura_tarihi ?></td>
                        <td class="border-b border-[#eee] py-5 px-4 text-center"><?= $is->odeme_tarihi ?></td>
